...
#' }
#' @export
Q <- function(lambda, tauinv2, p) {
    .Call('_StatComp21038_Q', PACKAGE = 'StatComp21038', lambda, tauinv2, p)
}
...
#' }
#' @export
EB <- function(L0, tol, tauinv2, p, lambda) {
    .Call('_StatComp21038_EB', PACKAGE = 'StatComp21038', L0, tol, tauinv2, p, lambda)
}
...
#' }
#' @export
HP <- function(tauinv2, r, d, p) {
    .Call('_StatComp21038_HP', PACKAGE = 'StatComp21038', tauinv2, r, d, p)
}
