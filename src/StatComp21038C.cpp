...
//' @export
// [[Rcpp::export]]
double Q(double lambda, NumericVector tauinv2, int p) {
...
//' EB(L0,tol,tauinv2,p,lambda)
//' }
//' @export
// [[Rcpp::export]]
NumericVector EB(double L0, double tol, NumericVector tauinv2, int p, double lambda){
...
double HP(NumericVector tauinv2, int r, int d, int p){
    double lambda2;
    int sh;
    double sc;
    sh = p+r;
